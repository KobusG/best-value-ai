...
const PRIORITY_SLUGS = [
  ...
  // Chinese frontier
  'glm-5', 'glm-5-2', 'glm-4-7', 'glm-4-7-flash',
  'minimax-m2-5', 'minimax-m2-7', 'minimax-m3',
  'kimi-k2-5', 'kimi-k3',
  'deepseek-v3-2',
  'deepseek-v4-pro', 'deepseek-v4-pro-non-reasoning',
...
const SLUG_TO_OUR_ID = {
  ...
  'deepseek-v4-pro-non-reasoning':    'deepseek-v4-pro',
  'deepseek-v4-flash':                'deepseek-v4-flash-reasoning',
  'deepseek-v4-flash-non-reasoning':  'deepseek-v4-flash',
